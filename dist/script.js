...
const modalTimerId = setTimeout(() => Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["showModal"])('.popup', modalTimerId), 60000);
Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.header_btn_wrap button', '.popup_engineer .popup_close', '.popup_engineer', modalTimerId);
Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.phone_link', '.popup .popup_close', '.popup', modalTimerId);
...
function forms() {
  ...
  forms.forEach(form => {
    form.addEventListener('submit', e => {
      ...
      load.textContent = formStates.loading;
      form.append(load);
      const formData = new FormData(form);
      const json = JSON.stringify(Object.fromEntries(formData.entries()));
      Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["postData"])('http://localhost:3000/menu', json).then(data => {
        console.log(data);
        load.textContent = formStates.success;
      }).catch(() => load.textContent = formStates.error);
    });
  });
}
...
function modal(triggeSelector, closerSelector, modalSelector, modalTimerId) {
  const modalTrigger = document.querySelectorAll(triggeSelector);
  const modalCloser = document.querySelectorAll(closerSelector);
  const modal = document.querySelector(modalSelector);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function tabs(parentSelector, blocksGroup, contentGroup, activeClass) {
  ...
  function showContent(i = 0) {
    ...
    blocksContent[i].style.display = 'block';
  }
